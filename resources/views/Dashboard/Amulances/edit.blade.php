                    ...
                    <form action="{{ route('Ambulance.update', $ambulance->id ) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <input type="number" name="drive_licence_number"
                                    value="{{ $ambulance->drive_licence_number }}"
                                    class="form-control @error('drive_licence_number') is-invalid @enderror">
                            </div>

                            <div class="col-6">
                                <label>رقم الهاتف</label>
                                <input type="number" name="drive_phone" value="{{ $ambulance->drive_phone }}"
                                    class="form-control @error('drive_phone') is-invalid @enderror">
                            </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <label>ملاحظات</label>
                                <textarea rows="5" cols="10" class="form-control" name="note">{{ $ambulance->note }}</textarea>
                            </div>
                        </div>
