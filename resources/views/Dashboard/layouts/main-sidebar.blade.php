...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category"> {{ trans('Dashboard/Main_sidebar.project_name') }} </li>
            <li class="slide">
            ...
            <li class="side-item side-item-category"> {{ trans('Dashboard/Main_sidebar.Categories') }} </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label"> {{ trans('Dashboard/Main_sidebar.Categories') }} </span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('sections.index') }}"> كل الأقسام </a></li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_paid')) }}"> الفواتير المدفوعة </a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}"> الفواتير الغير مدفوعه
                        </a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-echart')) }}"> الفواتير المدفوعه جزئيا
                        </a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label"> {{trans('Main_sidebar.doctors')}}  </span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('doctors.index') }}"> كل الاطباء  </a></li> 
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'mail-compose')) }}"> صلاحيات المستخدمين
                        </a>
                    </li>
                </ul>
            </li>
